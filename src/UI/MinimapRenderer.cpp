...
void MinimapRenderer::Draw(const LevelMap& levelMap, int currentGridX, int currentGridY) {
    ...
    constexpr float MINIMAP_SIZE = 140.0f;
    constexpr float RIGHT_PADDING = 4.0f;
    constexpr float TOP_PADDING = 10.0f;
    const float minimapSize = MINIMAP_SIZE;
    Vector2 anchor = {
        Constants::GAME_WIDTH - MINIMAP_SIZE - RIGHT_PADDING,
        TOP_PADDING
    };
